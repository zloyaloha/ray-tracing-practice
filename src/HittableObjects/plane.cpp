...
Plane::Plane(const point3 &base, double radius, const vec3 &normal, std::shared_ptr<Material> mat) :
                _base(base), _normal(normal.unit_vector()), _material(mat), _radius(radius) {}
